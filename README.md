...
1. Open `index.html` in a browser — it works immediately with localStorage.
2. Edit the `CONFIG` block at the bottom of `index.html`:
...
1. Host the files anywhere — the easiest free options:
...
2. In your project: SQL Editor → paste and run `schema.sql`
3. Go to Settings → API — copy your Project URL and anon key
4. In `index.html`, paste them:
   ```js
   const SUPABASE_URL = "https://your-project.supabase.co";
   const SUPABASE_KEY = "your-anon-key";
   const USE_SUPABASE = true;   // flip this to true
   ```
5. Deploy and reload — you now have real-time cross-device sync.
...
Use your initials, a simple shape, or generate one at [favicon.io](https://favicon.io).
